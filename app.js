var myApp = angular.module("myApp", ['ngRoute', 'ngAnimate', 'ui.bootstrap', 'AppAnimations', 'angularSmoothscroll']);
...
//    $('.animate-filter').hide();
//    $('.animate-filter').show('slow');
//  }
  $scope.paths= function() {

    $('.home-links').hide("slow");
    $('.main-link').show("slow");
    window.scrollTo(0,0);
  ...
  $scope.addSlide = function () {
    ...
    if($(window).width() > $(window).height()) {
      slides.push({
        image: ['./img/homepage-slider/laptop_tablet_bird2-min.jpg', './img/homepage-slider/Instagram_slide-min.jpg', './img/homepage-slider/data-wide-min.png'][slides.length % 3],
        text: [''][slides.length % 3],
        id: ['CSS', 'API', 'data'][slides.length % 3]
      });
      } else {
        slides.push({
          image: ['./img/homepage-slider/responsive-slide-tall-min.jpg', './img/homepage-slider/api-search-tall-min.png', './img/homepage-slider/data-tall-min.png'][slides.length % 3],
          text: [''][slides.length % 3],
          id: ['CSS', 'API', 'data'][slides.length % 3]
        });
    }
